...
const SidebarProvider = React.forwardRef(({ defaultOpen = true, open: controlledOpen, onOpenChange, className, style, children, ...props }, ref) => {
...
const SidebarTrigger = React.forwardRef(({ className, onClick, ...props }, ref) => {
    ...
    return (
      <Button
        ...
        variant="ghost"
        size="icon"
        className={cn("h-8 w-8 hover:bg-primary/10 hover:text-primary transition-colors", className)}
        onClick={(event) => {
          onClick?.(event);
          toggleSidebar();
        }}
